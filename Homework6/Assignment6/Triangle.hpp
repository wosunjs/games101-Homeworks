...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    inter.happened = true;
    inter.coords = this->v0 * u + this->v1 * v + this->v2 * gama; //交点p
